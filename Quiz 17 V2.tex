...
where $F_n(x)$ is the empirical distribution function of an $iid$ sequence $\lbrace X_i\rbrace$ with cdf $F$.
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{
...
\begin{math}
	\lbrace Y_i \rbrace 
\end{math}
is therefore also an $iid$ sequence, since $\lbrace Y_i \rbrace$ is $iid$ and indicate function is measurable, and
\end{itemize}
\begin{align*}
	E[Y_i]
